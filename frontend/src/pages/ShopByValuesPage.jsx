...
const VALUES = [
  {
    key: "all",
    label: "All Eco Products",
    emoji: "🌍",
    desc: "Browse our full sustainable range",
    color: "#2d8c5e",
  },
  {
    key: "low-carbon",
    label: "Low Carbon",
    emoji: "🌿",
    desc: "Products with ≤10% carbon emission",
    color: "#388e3c",
  },
  {
    key: "recycled",
    ...
    emoji: "♻️",
    desc: "Made from recycled or upcycled materials",
    color: "#1565c0",
  },
  {
    key: "plastic-free",
    label: "Plastic Free",
    emoji: "🌱",
    desc: "Zero plastic in materials or packaging",
    color: "#558b2f",
  },
  {
    key: "organic",
    ...
    emoji: "🌾",
    desc: "GOTS-certified or verified organic fibres",
    color: "#e65100",
  },
];
  ...
  useEffect(() => {
    ...
    const url =
      activeValue === "all"
        ...
        : `https://ecoshop-xoeh.onrender.com/api/products/byvalues?value=${activeValue}`;
    axios
      .get(url)
  ...
  return (
    <div style={{ background: "#f5faf6", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          Filter products by what matters most to you. Every item here is better
          for the planet.
        </p>
        <input
          type="text"
          ...
          {VALUES.map((v) => (
            <button
              ...
              style={{
                ...
                background: "none",
                cursor: "pointer",
                fontWeight: activeValue === v.key ? 700 : 500,
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "20px 20px 0" }}>
        ...
        >
          <span style={{ fontSize: 24 }}>
            {VALUES.find((v) => v.key === activeValue)?.emoji}
          </span>
          <div>
            <strong style={{ color: "#1a3d2b" }}>
              {VALUES.find((v) => v.key === activeValue)?.label}
            </strong>
            <p style={{ margin: 0, fontSize: 13, color: "#666" }}>
              {VALUES.find((v) => v.key === activeValue)?.desc}
            </p>
          </div>
      ...
      {/* ── Product Grid ── */}
      <div
        style={{ maxWidth: 960, margin: "24px auto 40px", padding: "0 20px" }}
      >
        {loading && (
